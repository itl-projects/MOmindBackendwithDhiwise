...
router.put('/admin/routerole/softDeleteMany',auth(...[ 'softDeleteManyByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
...
router.delete('/admin/routerole/deleteMany',auth(...[ 'deleteManyByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/admin/routerole/softDelete/:id',auth(...[ 'softDeleteByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
  routeRoleController.softDeleteRouteRole(req.pathParams.id,req.user
  ).then((result)=>{
    sendResponse(res,result);
  })
    .catch((error) => {
...
router.delete('/admin/routerole/delete/:id',auth(...[ 'deleteByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
  routeRoleController.deleteRouteRole(req.body,req.pathParams.id,req.user).then((result)=>{
    sendResponse(res,result);
  })
    .catch((error) => {
      sendResponse(res,error);
