...
router.put('/admin/userrole/softDeleteMany',auth(...[ 'softDeleteManyByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
...
router.delete('/admin/userrole/deleteMany',auth(...[ 'deleteManyByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/admin/userrole/softDelete/:id',auth(...[ 'softDeleteByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
  userRoleController.softDeleteUserRole(req.pathParams.id,req.user
  ).then((result)=>{
    sendResponse(res,result);
  })
    .catch((error) => {
...
router.delete('/admin/userrole/delete/:id',auth(...[ 'deleteByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
  userRoleController.deleteUserRole(req.body,req.pathParams.id,req.user).then((result)=>{
    sendResponse(res,result);
  })
    .catch((error) => {
      sendResponse(res,error);
