...
router.put('/admin/role/softDeleteMany',auth(...[ 'softDeleteManyByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
...
router.delete('/admin/role/deleteMany',auth(...[ 'deleteManyByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
...
router.put('/admin/role/softDelete/:id',auth(...[ 'softDeleteByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
  roleController.softDeleteRole(req.pathParams.id,req.user
  ).then((result)=>{
    sendResponse(res,result);
  })
    .catch((error) => {
...
router.delete('/admin/role/delete/:id',auth(...[ 'deleteByAdminInAdminPlatform' ]),(req,res,next)=>{
  req = adaptRequest(req);
  roleController.deleteRole(req.body,req.pathParams.id,req.user).then((result)=>{
    sendResponse(res,result);
  })
    .catch((error) => {
      sendResponse(res,error);
